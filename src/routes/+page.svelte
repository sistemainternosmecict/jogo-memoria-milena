...
<div class="background content flex min-h-screen flex-col bg-[#759499] text-white">
	<section
		class="z-1 m-3 flex flex-wrap items-center justify-center rounded-2xl bg-[#0b6170] p-5 shadow-xl"
	>
		<h1 class="flex flex-col rounded-tl-2xl rounded-tr-2xl text-center font-bold text-shadow-lg">
			<p class="text-5xl">Jogo da Memória</p>
			<p class="text-md">Biblioteca M. José Bandeira</p>
		</h1>
